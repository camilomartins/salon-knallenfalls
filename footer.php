	...
	<footer id="colophon" class="pt-2 md:pt-4 bg-black w-full inline-block fixed left-0 md:pl-24 md:pr-24 pl-8 pr-8 bottom-0 pb-4 font-serif text-slate-50" role="contentinfo">
		...
		<?php
			...
			wp_nav_menu([
				...
				'menu_class' => 'lg:flex lg:-mx-4 place-items-center grid grid-cols-3 gap-4 md:float-right',
