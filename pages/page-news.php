 ...
 */
      get_header(); 
?>
<div id="carousel" class="relative z-[55] min-h-[60vh] scroll-smooth ml-[calc(50%-50vw)] mr-[calc(50%-50vw)] mt-12 md:mt-24 pb-24 md:pb-32 flex items-center justify-start overflow-x-scroll scrollbar-hide">
      <?php 
            showCarousel("event");      
      ?>      
</div>
