...
?>
<div class="bg-black group flex flex-wrap md:pl-48 mb-10">
    <?php if( get_field('contact_information') ): ?>
        <?php while( the_repeater_field('contact_information') ): 
            ...
            ?>
            <div id="title-block" class="items-center flex md:p-10 mb-10 md:mb-0 text-primary ">
                <div class="group-even:order-last w-24 h-24 md:w-48 md:h-48 rounded-full mr-8 overflow-hidden">
                    <?php  
                        $image = get_sub_field('image');
    ...
    <div id="title-block" class="items-center flex p-10 text-primary ">
        <div class=" group-even:order-last w-24 h-24 md:w-48 md:h-48 rounded-full mr-10 overflow-hidden">
