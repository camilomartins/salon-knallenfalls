		...
		<div class="mx-auto flex flex-nowrap items-center ">
			...
			wp_nav_menu(
				array(
					...
					'container_class' => 'md:text-2xl md:mr-0 lg:mt-0 lg:p-0 lg:bg-transparent lg:block',
					'menu_class'      => 'flex text-base ',
					'theme_location'  => 'primary',
					'li_class'        => 'md:mr-8 md:text-2xl font-serif text-primary font-thin  lg:mb-0  mx-4 last:mx-0 hover:underline hover:underline-offset-4',
					'fallback_cb'     => false,
				)
			);
			?>
