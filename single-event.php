...
<div class="" id="post-<?php the_ID(); ?>" > <?php// post_class(); ?>
	<div class="relative    md:px-12 z-10 container shrink mx-auto  min-h-screen">
		<div id="post-<?php the_ID(); ?>" <?php post_class('mb-24 flex flex-wrap'); ?>> 
				<div class=" md:w-1/2">
                    ...
                    <div class=" md:w-full ">
						...
						?>
							...
							<div class="hover:animate-spin-slow font-bold font-serif text-xl w-40 h-40 text-black bg-white flex place-items-center rounded-full relative md:absolute mb-20 md:-bottom-20  ml-4 md:-right-20">
				...
				<div class="md:ml-24 mt-24 md:mt-60 md:p-6 md:w-1/2 md:pl-16 md:pt-6 text-primary place-items-center">
                  	<div class="">
