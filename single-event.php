		...
		<div id="post-<?php the_ID(); ?>" <?php post_class('mb-24 flex flex-wrap md:flex-nowrap'); ?>> 
				<div class=" md:w-1/2 ">                                      
						<div class="relative">
							...
							<div class="z-50 -mt-16 object-center float-right hover:animate-spin-slow font-bold font-serif md:w-40 md:h-40 w-28 h-28 text-black bg-white  place-items-center absolute rounded-full md:absolute md:-bottom-20  md:-right-20 -bottom-14 -right-14">
